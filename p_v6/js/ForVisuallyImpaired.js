if (!localStorage.getItem('forMobileApp')) {
    $.ajax({
        url: '/rest/api/hasForVisuallyImpairedLicense',
            ...
            if (response.hasLicense) {
                ...
                switch (localStorage.getItem('language')) {
                    case '1':
                        ...
                        break;
                    case '2':
                        text = 'Көру қабілеті нашар адамдарға арналған режимге ауысу';
                        break;
                    case '3':
                        text = 'Switch to visually impaired mode';
                        break;
                    default:
                        text = 'Перейти в режим для слабовидящих';
                        break;
                ...
                a.id = "specialButton";
                if (document.getElementById("specialButtonAddLocation")) {
                    document.getElementById("specialButtonAddLocation").appendChild(a);
                }
                setTimeout(() => {
                        ...
                        special = {
                            ...
                            Off: function() {
                                if ($("#specialButton").length) {
                                    ...
                                    $("#layout-menu").css("padding-top", "");
                                    $("#layout-navbar").css("top", "");
                            ...
                            On: function() {
                                $("head").append($('<link rel="stylesheet" type="text/css" />').attr("href", "/p_v6/css/ForVisuallyImpaired.css"));
                                ...
                                $("body").prepend($($tpl));
                                // $("#layout-menu").css("padding-top", "53px");
                                // $("#layout-navbar").css("top", "53px");
                                // $(".content-wrapper").css("padding-top", "53px");
                                special.Set();
                    ...
                    jQuery(function($) {
                        ...
                        if ($("#specialButton").length) {
                            ...
                            $('body').on("click", '#specialButton', special.On)

                        }
                        $("html").fadeIn(0, "linear")
                    });
                    (function(factory) {
                    ...
                    var $tpl =
                        ...
                        '           <button title="Цвет желтый по черному" value="6"><i>Ц</i></button>' +
                        ...
                        */
                        ...
                        '           <button value="1"><i>Без засечек</i></button>' +
                        '           <button value="2"><i>С засечками</i></button>' +
                        '       </div>' +
